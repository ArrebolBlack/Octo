...
flags.DEFINE_string("ip", "10.140.16.1", "IP address of the robot")
flags.DEFINE_integer("port", 30004, "Port of the robot")
# flags.DEFINE_spaceseplist("goal_eep", [0.3, 0.0, 0.15], "Goal position")
flags.DEFINE_spaceseplist("initial_position", [0.3, 0.0, 0.15], "Initial position")
