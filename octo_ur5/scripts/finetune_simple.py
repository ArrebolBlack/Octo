...
flags.DEFINE_string(
    "pretrained_path", "/home/xiaosa/Newpython/Octo/octo/octo-base-1.5", "Path to pre-trained Octo checkpoint directory."
)
flags.DEFINE_string("data_dir", '/home/xiaosa/Newpython/Octo/pick_reset_1.00', "Path to finetuning dataset, in RLDS format.")
# /home/xiaosa/Newpython/Octo/data_test/pybullet_ur5_pick_reset_cup_mug/1.0.0
flags.DEFINE_string("save_dir", "/home/xiaosa/Newpython/Octo/save_finetuning_chechpoints_real_2", "Directory for saving finetuning checkpoints.")
